...
<body style="background-color: rgb(114, 113, 107);">
    <script>
        function incr(str) {
            if(str===""){
                return;
    ...
    <?php
        ...
        if (isset($_SESSION['admin'])) {
            $msg = "Admin Cannot Upload Hostel Details";
    ...
    <div class="container-fluid" style="width: 100%;margin-top: 10px;">
        <div style="width: 63%;background-color: chartreuse;float:left;border-radius: 30px;margin-right: 2%;">
        ...
        <div style="float: left;background-color: cyan;width: 35%;border-radius: 10px;">
            <?php
                if(isset($_SESSION['user']))
                {
                    ...
                    <table style="width: 100%;">
                        <tr style="border-top: 3px solid black;">
                            ...
                            <th class="inc" style="text-align: center;">Action</th>
                        </tr>';
